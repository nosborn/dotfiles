" -----------------------------------------------------------------------------
" File: gruvbox.vim
" Description: Gruvbox colorscheme for mayonnaise (itchyny/mayonnaise.vim)
...
if exists('g:mayonnaise')
  ...
  let g:mayonnaise#colorscheme#gruvbox#palette = mayonnaise#colorscheme#flatten(s:p)
endif
